...
class LunchDinnerComponent extends Component {
    constructor(props){
        super()
    ...
    render() {
        // console.log(this.props.args.elem) 
        let list_down_btn_LD = this.props.args.list_down_btn_LD
        return (
            <div className="food-list-row">
                <div id="food-pic-div">
                <img id="food-img" src={require("../imgs/lunch_dinner_imgs/" + this.props.args.elem.imgURL)} alt="food-img" />
                ...
                <div id="food-info-div">
                    ...
                    <button 
                        ...
                        style={list_down_btn_LD}
                        onClick={() => {
                            this.props.args.handleOnListDownClick({
                                id: "ld-" + this.props.args.elem.id.toString(),     
...
export default LunchDinnerComponent;